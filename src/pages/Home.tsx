...
// import { useVarietyNewsStore } from '../stores/useVarietyStore';
...
const Home = () => {
    ...
    // const { varietyNewsVideo, onFetchVideo } = useVarietyNewsStore();
    ...
    const randomList = useMemo<PrimaryItem[]>(() => {
        return randomArray([
            // ...popularMovies.map((v) => ({ ...v, mediaType: 'movie' })), // 영화 제거하고 wavves랑 tvs 에서만 돌리기
