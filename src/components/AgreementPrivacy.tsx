        ...
        <div>
            ...
            <div className="policy-desc">
                ...
                <table className="table-contents">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td onClick={() => scrollTo('terms-article-8')}>
                                제8조 개인정보 안전성 확보조치
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td onClick={() => scrollTo('terms-article-12')}>
                                제12조 권익침해에 대한 구제방법
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td onClick={() => scrollTo('terms-article-7')}>
                                제7조 가명정보 처리에 관한 사항
                            </td>
                            <td>
                                <br />
                ...
                <section id="terms-article-2">
                    ...
                    <p>
                        회사는 개인정보의 보유기간의 경과, 처리목적 달성 등 개인정보가 불필요하게
                        ...
                        <table>
                            ...
                            <tbody>
                                <tr>
                                    <th>파기 절차</th>
                                    <td colSpan={2}>
                                        파기대상 개인정보 선정 → 개인정보책임자 검토 및 승인 → 파기
                                    </td>
                                </tr>
                                <tr>
                    ...
                    <div className="table-wrapper">
                        <table>
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        SK텔레콤㈜, SK브로드밴드㈜, 드림어스컴퍼니(주), 케이티, ㈜KT
                                        스카이라이프, ㈜엔에이치엔벅스
                                    </td>
                                ...
                                <tr>
                                    <td>(주) 티빙</td>
                                    <td>
                                        제휴 상품 서비스 가입 및 제공, 이용 분석, 개인화 서비스 제공
                                        등
                                    </td>
                ...
                <section id="terms-article-6">
                    ...
                    <p>
                        회사는 원활한 개인정보 업무처리를 위하여 다음과 같이 회원의 개인정보를
                        국외로 이전하고 있습니다.
                    </p>
                    <div className="table-wrapper">
                        <table>
                ...
                <section id="terms-article-8">
                    ...
                    <ul>
                        ...
                        <li>
                            <strong>기술적 조치:</strong> 접근권한 관리, 개인정보 암호화,
                            보안프로그램 설치
                        </li>
                        <li>
                ...
                <section id="terms-article-9">
                    ...
                    <p>
                        회사는 서비스 이용과정에서 회원에게 최적화된 편의를 제공하기 위해
                        ‘쿠키(Cookie)’를 사용합니다.
                    </p>
                    <div className="table-wrapper">
                        <table>
                ...
                <section id="terms-article-10">
                    ...
                    <p>
                        이용자는 언제든지 등록되어 있는 자신의 개인정보를 열람하거나 수정할 수
                        있으며, 가입해지를 요청할 수 있습니다.
                    </p>
                    <ul>
                ...
                <section id="terms-article-13">
                    ...
                    <p>
                        법령 개정이나 서비스 개선 및 변경 등으로 인해 개인정보 처리방침이 변경되는
                        경우, 변경 사항을 사전에 공지사항을 통해 안내드리겠습니다.
                    </p>
                    <p>
